...
- [ ] Diseño consistente con sistema existente (fuente de sistema, variables CSS)
- [ ] Funciona en móvil
- [ ] Sin dependencias nuevas sin justificación
- [ ] No mezcla Entrega 1 y Entrega 2 en el mismo run
- [ ] Compatible con roadmap (Entrega 2 con API externa, Fase 2 de metas de
      conocimiento) — no cierra puertas al modelo de datos ya definido
- [ ] Sin funcionalidad social, de compartir o de seguir usuarios (prohibido en
      todas las fases)
...
4. Sé exigente — este producto tiene aspiración comercial y estándar Apple-like
