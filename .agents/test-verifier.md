...
**Seguridad:**
- [ ] escHtml() aplicado en todo innerHTML nuevo (incluida data de API externa)
- [ ] Firestore rules no modificadas
- [ ] No hay datos de usuario expuestos entre uid distintos
...
4. Probá mentalmente cada edge case, incluidos los cruces entre status y priority
...
- [ ] Todo texto de usuario (y de la API externa) pasa por escHtml() antes de innerHTML
...
- [ ] Los libros de un usuario no son accesibles por otro
